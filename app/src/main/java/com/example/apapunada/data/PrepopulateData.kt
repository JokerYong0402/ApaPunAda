...
object PrepopulateData {
    val users = listOf(
        User(username = "John", email = "john@gmail.com", password = "aacs3353", phoneNo = "01524365443", gender = "Male", dob = 1072915200000, image = "john.jpg", role = "User", point = 700, status = "Active"),
        ...
        User(username = "Ryan Moey Kai Xiang", email = "ryan@gmail.com", password = "ryanm0525", phoneNo = "0123456789", gender = "Male", dob = 1085443200, image = "ryan.jpg", role = "User", point = 423, status = "Active"),
        User(username = "Yong Jia Ying", email = "jiaying@gmail.com", password = "yjy12345", phoneNo = "0137652345", gender = "Female", dob = 1080864000, image = "jy.jpg", role = "User", point = 210, status = "Active"),
        User(username = "Kong Weng Cheng", email = "kongwc@gmail.com", password = "kwc12345", phoneNo = "0147653321", gender = "Male", dob = 1073952000, image = "wc.jpg", role = "User", point = 360, status = "Active"),
        User(username = "Yoong Hong Sheng", email = "yhsheng@gmail.com", password = "yhs12345", phoneNo = "0117593341", gender = "Male", dob = 1072137600, image = "hs.jpg", role = "User", point = 560, status = "Active"),
        User(username = "Siow Ying Long", email = "yinglong@gmail.com", password = "syl2345", phoneNo = "0198654321", gender = "Male", dob = 978307200, image = "yl.jpg", role = "User", point = 150, status = "Active"),
        User(username = "Willis Ong Wei Chen", email = "weichen@gmail.com", password = "wcl2345", phoneNo = "0187654320", gender = "Male", dob = 946684800, image = "owc.jpg", role = "User", point = 670, status = "Active"),
        User(username = "Yow Yee Qin", email = "yeeqin@gmail.com", password = "yql2345", phoneNo = "0137638790", gender = "Male", dob = 982857600, image = "yq.jpg", role = "User", point = 170, status = "Active"),
        User(username = "Ang Yong Tat", email = "yongtat@gmail.com", password = "ytl2345", phoneNo = "0147120791", gender = "Male", dob = 1085155200, image = "yt.jpg", role = "User", point = 390, status = "Active"),
        User(username = "Alden Ling Li Xuan", email = "aldenling@gmail.com", password = "aldenl2345", phoneNo = "0137167561", gender = "Male", dob = 1089561600, image = "alden.jpg", role = "User", point = 210, status = "Active"),
        User(username = "Edison", email = "edison@gmail.com", password = "edisonl2345", phoneNo = "0142333771", gender = "Male", dob = 1093968000, image = "edison.jpg", role = "User", point = 190, status = "Active"),
        User(username = "Jane Smith", email = "jane@gmail.com", password = "password456", phoneNo = "0198765432", gender = "Female", dob = 978307200, image = "jane.jpg", role = "User", point = 150, status = "Active"),
        User(username = "Mark Jackson", email = "mark@gmail.com", password = "password789", phoneNo = "0198765431", gender = "Male", dob = 946684800, image = "mark.jpg", role = "User", point = 200, status = "Active"),
        User(username = "Sara Williams", email = "sara@gmail.com", password = "passwordabc", phoneNo = "0128856789", gender = "Female", dob = 1041379200, image = "sara.jpg", role = "User", point = 80, status = "Disabled"),
        User(username = "Chris Brown", email = "chris@gmail.com", password = "passworddef", phoneNo = "0167890345", gender = "Male", dob = 924076800, image = "chris.jpg", role = "User", point = 120, status = "Active"),
        User(username = "Emily Johnson", email = "emily@gmail.com", password = "passwordghi", phoneNo = "0154321876", gender = "Female", dob = 1035465600, image = "emily.jpg", role = "User", point = 180, status = "Active"),
        User(username = "Michael Clark", email = "michael@gmail.com", password = "passwordjkl", phoneNo = "0189034567", gender = "Male", dob = 955177600, image = "michael.jpg", role = "User", point = 90, status = "Active"),
        User(username = "Amanda Lee", email = "amanda@gmail.com", password = "passwordmno", phoneNo = "0123456781", gender = "Female", dob = 1009372800, image = "amanda.jpg", role = "User", point = 140, status = "Active"),
        User(username = "David Moore", email = "david@gmail.com", password = "passwordpqr", phoneNo = "0134567812", gender = "Male", dob = 1001750400, image = "david.jpg", role = "User", point = 220, status = "Active"),
        User(username = "Lisa Anderson", email = "lisa@gmail.com", password = "passwordstu", phoneNo = "0145678973", gender = "Female", dob = 957651600, image = "lisa.jpg", role = "User", point = 110, status = "Disabled"),
        User(username = "Brian Wilson", email = "brian@gmail.com", password = "passwordvwx", phoneNo = "0156789234", gender = "Male", dob = 1012665600, image = "brian.jpg", role = "User", point = 130, status = "Active"),
        User(username = "Jessica Brown", email = "jessica@gmail.com", password = "passwordxyz", phoneNo = "0167814345", gender = "Female", dob = 992851200, image = "jessica.jpg", role = "User", point = 160, status = "Active"),
        User(username = "Daniel Taylor", email = "daniel@gmail.com", password = "password123", phoneNo = "0178901139", gender = "Male", dob = 986787600, image = "daniel.jpg", role = "User", point = 240, status = "Active"),
        User(username = "Emma Thomas", email = "emma@gmail.com", password = "password456", phoneNo = "0191234567", gender = "Female", dob = 1014950400, image = "emma.jpg", role = "User", point = 70, status = "Disabled"),
        User(username = "William Harris", email = "william@gmail.com", password = "password789", phoneNo = "0195345678", gender = "Male", dob = 982972800, image = "william.jpg", role = "User", point = 110, status = "Active"),
        User(username = "Olivia Martinez", email = "olivia@gmail.com", password = "passwordabc", phoneNo = "0123455689", gender = "Female", dob = 971121600, image = "olivia.jpg", role = "User", point = 130, status = "Active"),
        User(username = "Alexander Young", email = "alexander@gmail.com", password = "passworddef", phoneNo = "0133567894", gender = "Male", dob = 1021996800, image = "alexander.jpg", role = "User", point = 200, status = "Active"),
        User(username = "Sophia Walker", email = "sophia@gmail.com", password = "passwordghi", phoneNo = "0123456711", gender = "Female", dob = 1003612800, image = "sophia.jpg", role = "User", point = 90, status = "Active"),
        User(username = "James King", email = "james@gmail.com", password = "passwordjkl", phoneNo = "0134567892", gender = "Male", dob = 993465600, image = "james.jpg", role = "User", point = 150, status = "Active"),
        User(username = "Charlotte Scott", email = "charlotte@gmail.com", password = "passwordmno", phoneNo = "0145678903", gender = "Female", dob = 983404800, image = "charlotte.jpg", role = "User", point = 120, status = "Disabled"),
        User(username = "Benjamin Allen", email = "benjamin@gmail.com", password = "passwordpqr", phoneNo = "0156788214", gender = "Male", dob = 1015801600, image = "benjamin.jpg", role = "User", point = 220, status = "Active"),
        User(username = "Ella Garcia", email = "ella@gmail.com", password = "passwordstu", phoneNo = "0167890300", gender = "Female", dob = 987523200, image = "ella.jpg", role = "User", point = 140, status = "Active"),
        User(username = "Noah Martinez", email = "noah@gmail.com", password = "passwordvwx", phoneNo = "0178923996", gender = "Male", dob = 1001164800, image = "noah.jpg", role = "Staff", point = 230, status = "Active"),
        User(username = "Mia Lopez", email = "mia@gmail.com", password = "password123", phoneNo = "0189218567", gender = "Female", dob = 983088000, image = "mia.jpg", role = "User", point = 100, status = "Disabled"),
        User(username = "Liam Gonzalez", email = "liam@gmail.com", password = "password456", phoneNo = "0190175628", gender = "Male", dob = 992851200, image = "liam.jpg", role = "User", point = 120, status = "Active"),
        User(username = "Avery Hernandez", email = "avery@gmail.com", password = "password789", phoneNo = "0138536789", gender = "Female", dob = 972172800, image = "avery.jpg", role = "User", point = 110, status = "Active"),
        User(username = "Ethan Perez", email = "ethan@gmail.com", password = "passwordabc", phoneNo = "01234567590", gender = "Male", dob = 1013539200, image = "ethan.jpg", role = "Staff", point = 210, status = "Active"),
        User(username = "Isabella Sanchez", email = "isabella@gmail.com", password = "passworddef", phoneNo = "0123456336", gender = "Female", dob = 981916800, image = "isabella.jpg", role = "User", point = 80, status = "Active"),
        User(username = "Lucas Ramirez", email = "lucas@gmail.com", password = "passwordghi", phoneNo = "0134563612", gender = "Male", dob = 995068800, image = "lucas.jpg", role = "User", point = 130, status = "Active"),
        User(username = "Scarlett Torres", email = "scarlett@gmail.com", password = "passwordjkl", phoneNo = "0145694423", gender = "Female", dob = 1021142400, image = "scarlett.jpg", role = "User", point = 150, status = "Disabled"),
        User(username = "Jackson Flores", email = "jackson@gmail.com", password = "passwordmno", phoneNo = "0156729234", gender = "Male", dob = 993907200, image = "jackson.jpg", role = "Staff", point = 240, status = "Active"),
        User(username = "Madison Gomez", email = "madison@gmail.com", password = "passwordpqr", phoneNo = "0112778908", gender = "Female", dob = 1007030400, image = "madison.jpg", role = "User", point = 160, status = "Active"),
        User(username = "Aiden Reyes", email = "aiden@gmail.com", password = "passwordstu", phoneNo = "0173341278", gender = "Male", dob = 990662400, image = "aiden.jpg", role = "Staff", point = 220, status = "Active"),
        User(username = "Chloe Hernandez", email = "chloe@gmail.com", password = "passwordvwx", phoneNo = "0125543478", gender = "Female", dob = 981100800, image = "chloe.jpg", role = "User", point = 90, status = "Disabled"),
        User(username = "Mason Nunez", email = "mason@gmail.com", password = "password123", phoneNo = "0176669090", gender = "Male", dob = 987177600, image = "mason.jpg", role = "User", point = 110, status = "Active"),
        User(username = "Evelyn Alvarez", email = "evelyn@gmail.com", password = "password456", phoneNo = "0122221890", gender = "Female", dob = 1023830400, image = "evelyn.jpg", role = "User", point = 130, status = "Active"),
        User(username = "Logan Jimenez", email = "logan@gmail.com", password = "password789", phoneNo = "0180314613", gender = "Male", dob = 998390400, image = "logan.jpg", role = "Staff", point = 210, status = "Active"),
        User(username = "Grace Gutierrez", email = "grace@gmail.com", password = "passwordabc", phoneNo = "0196667023", gender = "Female", dob = 986217600, image = "grace.jpg", role = "User", point = 80, status = "Active"),
        User(username = "Elijah Castillo", email = "elijah@gmail.com", password = "passworddef", phoneNo = "0132215287", gender = "Male", dob = 1015052800, image = "elijah.jpg", role = "User", point = 140, status = "Active"),
        User(username = "Aria Gonzalez", email = "aria@gmail.com", password = "passwordghi", phoneNo = "0153336750", gender = "Female", dob = 990748800, image = "aria.jpg", role = "User", point = 150, status = "Disabled"),
        User(username = "Oliver Perez", email = "oliver@gmail.com", password = "passwordjkl", phoneNo = "0112315567", gender = "Male", dob = 1006185600, image = "oliver.jpg", role = "Staff", point = 230, status = "Active")
    )
    ...
    val menuItemList = listOf(
        ...
        MenuItem(itemName = "Iced Latte", cuisine = "Beverage", price = 10.90, rating = 4.9, image = "iced_latte.jpg", description = "Refreshing espresso mixed with chilled milk and served over ice", status = "Active"),
        ...
        MenuItem(itemName = "Prawn Mee", cuisine = "Malaysian", price = 9.00, rating = 4.6, image = "prawn_mee.jpg", description = "Thick yellow noodles fried in a rich prawn and pork stock and served with chilli", status = "Active"),
        ...
        MenuItem(itemName = "Tempura Platter", cuisine = "Japanese", price = 21.90, rating = 4.7, image = "tempura_platter.jpg", description = "Lightly battered and deep-fried seafood and vegetables served with dipping sauce", status = "Active"),
        ...
        MenuItem(itemName = "Roti Canai", cuisine = "Malaysian", price = 3.00, rating = 4.6, image = "roti_canai.jpg", description = "Flaky and crispy Malaysian flatbread served with curry dipping sauce", status = "Active"),
        MenuItem(itemName = "Green Papaya Salad", cuisine = "Thai", price = 8.10, rating = 4.5, image = "green_papaya_salad.jpg", description = "Shredded green papaya mixed with tomatoes, peanuts, and chili peppers in a tangy dressing", status = "Active"),
        MenuItem(itemName = "Iced Lemon Tea", cuisine = "Beverage", price = 3.80, rating = 4.7, image = "iced_lemon_tea.jpg", description = "combines black tea, fresh lemon juice, and sugar to make a bold and refreshing drink", status = "Active"),
        ...
        MenuItem(itemName = "Bibim Naengmyeon", cuisine = "Korean", price = 13.60, rating = 4.7, image = "bibim_naengmyeon.jpg", description = "Chilled buckwheat noodles mixed with spicy sauce, vegetables, and a boiled egg", status = "Active"),
        MenuItem(itemName = "Mango Lassi", cuisine = "Beverage", price = 5.90, rating = 4.6, image = "mango_lassi.jpg", description = "Refreshing Indian yogurt drink blended with ripe mangoes and a hint of cardamom", status = "Active")
    )
    ...
    val foodDetailsList = listOf(
        ...
        FoodDetails(menuItemID = 6, servingSize = 450.0, ingredient = "Espresso, milk, ice, sugar syrup"),
        ...
        FoodDetails(menuItemID = 26, servingSize = 380.0, ingredient = "Black tea, lemon juice, sugar, ice cubes"),
        ...
        FoodDetails(menuItemID = 30, servingSize = 230.0, ingredient = "Yogurt, ripe mangoes, cardamom, honey, ice cubes")
    )
    ...
    val orderDetailsList = listOf(
        OrderDetails(orderID = 1, menuItemID = 2, quantity = 2, remark = "No onions", option = "Large", total = 50.80),
        OrderDetails(orderID = 1, menuItemID = 3, quantity = 1, remark = "Extra spicy", option = "Medium", total = 18.70),
        OrderDetails(orderID = 2, menuItemID = 4, quantity = 3, remark = "No cucumber", option = "Small", total = 10.50),
        OrderDetails(orderID = 2, menuItemID = 5, quantity = 2, remark = "Extra shrimp", option = "Medium", total = 24.00),
        OrderDetails(orderID = 3, menuItemID = 6, quantity = 1, remark = "Less chili", option = "Cold", total = 10.90),
        OrderDetails(orderID = 3, menuItemID = 7, quantity = 2, remark = "Extra sauce", option = "Hot", total = 71.60),
        OrderDetails(orderID = 4, menuItemID = 8, quantity = 3, remark = "No onions", option = "Medium", total = 107.40),
        OrderDetails(orderID = 4, menuItemID = 9, quantity = 1, remark = "Extra avocado", option = "Large", total = 38.90),
        OrderDetails(orderID = 5, menuItemID = 10, quantity = 2, remark = "No peanuts", option = "Cold", total = 20.00),
        OrderDetails(orderID = 5, menuItemID = 11, quantity = 1, remark = "Extra egg", option = "Hot", total = 8.50),
        OrderDetails(orderID = 6, menuItemID = 12, quantity = 3, remark = "Less spicy", option = "Small", total = 43.50),
        OrderDetails(orderID = 6, menuItemID = 13, quantity = 1, remark = "Extra rice", option = "Medium", total = 14.80),
        OrderDetails(orderID = 7, menuItemID = 14, quantity = 2, remark = "No pork", option = "Large", total = 71.60),
        OrderDetails(orderID = 7, menuItemID = 15, quantity = 1, remark = "Extra tofu", option = "Cold", total = 14.50),
        OrderDetails(orderID = 8, menuItemID = 16, quantity = 3, remark = "No basil", option = "Small", total = 35.70),
        OrderDetails(orderID = 8, menuItemID = 17, quantity = 1, remark = "Extra chicken", option = "Medium", total = 12.90),
        OrderDetails(orderID = 9, menuItemID = 18, quantity = 2, remark = "No sambal", option = "Large", total = 60.00),
        OrderDetails(orderID = 9, menuItemID = 19, quantity = 1, remark = "Extra anchovies", option = "Cold", total = 4.50),
        OrderDetails(orderID = 10, menuItemID = 20, quantity = 3, remark = "Less lime", option = "Medium", total = 27.00),
        OrderDetails(orderID = 10, menuItemID = 21, quantity = 1, remark = "Extra chili", option = "Hot", total = 8.80),
        OrderDetails(orderID = 11, menuItemID = 22, quantity = 2, remark = "No pickles", option = "Large", total = 91.00),
        OrderDetails(orderID = 11, menuItemID = 23, quantity = 1, remark = "Extra coconut milk", option = "Cold", total = 8.10),
        OrderDetails(orderID = 12, menuItemID = 24, quantity = 3, remark = "Less pork", option = "Small", total = 60.90),
        OrderDetails(orderID = 12, menuItemID = 25, quantity = 1, remark = "Extra noodles", option = "Medium", total = 13.50),
        OrderDetails(orderID = 13, menuItemID = 26, quantity = 2, remark = "No kimchi", option = "Large", total = 29.60),
        OrderDetails(orderID = 13, menuItemID = 27, quantity = 1, remark = "Extra vegetables", option = "Cold", total = 9.60),
        OrderDetails(orderID = 14, menuItemID = 28, quantity = 3, remark = "No soy sauce", option = "Small", total = 25.80),
        OrderDetails(orderID = 14, menuItemID = 29, quantity = 1, remark = "Extra wasabi", option = "Medium", total = 11.20),
        OrderDetails(orderID = 15, menuItemID = 30, quantity = 2, remark = "Less shrimp", option = "Large", total = 10.80),
        OrderDetails(orderID = 15, menuItemID = 1, quantity = 1, remark = "Extra rice noodles", option = "Cold", total = 10.00),
        OrderDetails(orderID = 16, menuItemID = 2, quantity = 3, remark = "No lettuce", option = "Medium", total = 38.10),
        OrderDetails(orderID = 16, menuItemID = 3, quantity = 1, remark = "Extra crab", option = "Hot", total = 12.90),
        OrderDetails(orderID = 17, menuItemID = 4, quantity = 2, remark = "No avocado", option = "Large", total = 25.80),
        OrderDetails(orderID = 17, menuItemID = 5, quantity = 1, remark = "Extra cucumber", option = "Cold", total = 12.00),
        OrderDetails(orderID = 18, menuItemID = 6, quantity = 3, remark = "Less beef", option = "Small", total = 56.10),
        OrderDetails(orderID = 18, menuItemID = 7, quantity = 1, remark = "Extra eggs", option = "Medium", total = 17.70),
        OrderDetails(orderID = 19, menuItemID = 8, quantity = 2, remark = "No lettuce", option = "Large", total = 71.60),
        OrderDetails(orderID = 19, menuItemID = 9, quantity = 1, remark = "Extra sauce", option = "Cold", total = 38.90),
        OrderDetails(orderID = 20, menuItemID = 10, quantity = 3, remark = "No sambal", option = "Medium", total = 10.50),
        OrderDetails(orderID = 20, menuItemID = 11, quantity = 1, remark = "Extra anchovies", option = "Hot", total = 4.50),
        OrderDetails(orderID = 21, menuItemID = 12, quantity = 2, remark = "No lime leaves", option = "Large", total = 21.00),
        OrderDetails(orderID = 21, menuItemID = 13, quantity = 1, remark = "Extra chili peppers", option = "Cold", total = 8.10),
        OrderDetails(orderID = 22, menuItemID = 14, quantity = 3, remark = "Less barbecue sauce", option = "Small", total = 107.40),
        OrderDetails(orderID = 22, menuItemID = 15, quantity = 1, remark = "Extra ribs", option = "Medium", total = 35.80),
        OrderDetails(orderID = 23, menuItemID = 16, quantity = 2, remark = "No soy sauce", option = "Large", total = 51.60),
        OrderDetails(orderID = 23, menuItemID = 17, quantity = 1, remark = "Extra wasabi", option = "Cold", total = 11.20),
        OrderDetails(orderID = 24, menuItemID = 18, quantity = 3, remark = "Less shrimp", option = "Medium", total = 27.00),
        OrderDetails(orderID = 24, menuItemID = 19, quantity = 1, remark = "Extra rice", option = "Hot", total = 10.50),
        OrderDetails(orderID = 25, menuItemID = 20, quantity = 2, remark = "No nuts", option = "Large", total = 17.00),
        OrderDetails(orderID = 25, menuItemID = 21, quantity = 1, remark = "Extra mango", option = "Cold", total = 8.80),
        OrderDetails(orderID = 26, menuItemID = 21, quantity = 1, remark = "Extra mango", option = "Cold", total = 8.80),
        OrderDetails(orderID = 27, menuItemID = 21, quantity = 1, remark = "Extra mango", option = "Cold", total = 8.80),
        OrderDetails(orderID = 28, menuItemID = 21, quantity = 1, remark = "Extra mango", option = "Cold", total = 8.80),
        OrderDetails(orderID = 29, menuItemID = 21, quantity = 1, remark = "Extra mango", option = "Cold", total = 8.80),
        OrderDetails(orderID = 30, menuItemID = 21, quantity = 1, remark = "Extra mango", option = "Cold", total = 8.80),
    )
